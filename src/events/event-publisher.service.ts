...
import { AuditEventType, ZorbitEventEnvelope } from './audit.events';
...
export class EventPublisherService implements OnModuleInit, OnModuleDestroy {
   ...
   * @param eventType - e.g. 'audit.record.created'
  ...
  async publish<T>(
    ...
    const topic = eventType.replace(/\./g, '-'); // audit.record.created → audit-record-created
